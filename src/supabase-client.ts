...
console.log('SUPABASE_ANON_KEY:', SUPABASE_ANON_KEY ? SUPABASE_ANON_KEY.substring(0, 8) + '...' : 'NOT SET');
...
export function createBrowserClient() {
  ...
  if (!window.__supabaseClient) {
    ...
    if (isDevelopment) {
      console.log('Skapar Supabase-klient med mock-autentisering för utvecklingsmiljö');
